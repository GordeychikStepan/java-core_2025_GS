...
/*  Напишите программу с классом, в котором есть два поля: символьное и текстовое. В классе должен быть
    ...
    (если в массиве больше одного элемента) из символов массива формируется текстовая строка
    и присваивается значением текстовому полю. */

public class Main {
    public static void main(String[] args) {

        CharTextHolder obj = new CharTextHolder();

        obj.setValue('A');
        System.out.println(obj); // ch = A

        obj.setValue("Привет");
        System.out.println(obj); // text = Привет

        obj.setValue(new char[]{'Z'});
        System.out.println(obj); // ch = Z
